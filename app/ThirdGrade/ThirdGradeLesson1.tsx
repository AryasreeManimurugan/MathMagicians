...
const ThirdGradeLesson1: React.FC = () => {
  ...
  const questions = [
    ...
    {
      key: "q7",
      text: "Do the Multiplition: 23 * 12   ",
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        ...
        In this lesson, we will discuss multiplication of two digit numbers. After you have finished the video below, enjoy practicing with the new skills you have achieved today. Go Magicians!
        </Text>
      </View>
