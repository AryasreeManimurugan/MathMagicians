...
const SecGradeLesson1: React.FC = () => {
  ...
  const questions = [
    ...
    {
      key: "q5",
      text: "Do the Substraction: = Do the addition: 39 + 45",
      options: ["13", "2", "84", "9"],
    },
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        ...
        In this lesson, we will discuss further on arithmetics. We will learn how to do addition in double digits. After you have finished the video below, enjoy practicing with the new skills you have achieved today. Go Magicians!
        </Text>
      </View>
